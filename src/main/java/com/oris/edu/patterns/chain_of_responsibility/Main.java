...
import com.oris.edu.patterns.factory_method.ModelsStatisticCalculator;
...
public class Main {
    public static void main(String[] args) throws DuplicateModelNameException, IOException {
        Transport tesla = ModelsStatisticCalculator.createInstance("Tesla", 10);
        tesla.addModel("Model X", 10000);
        tesla.addModel("Model Y", 120000);
        tesla.addModel("Model Z", 1220000);
        tesla.addModel("Model A", 50000);

        Transport tesla2 = ModelsStatisticCalculator.createInstance("Tesla2", 10);
